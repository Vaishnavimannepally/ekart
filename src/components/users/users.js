...
function Users() {
  ...
  return (
    <div className="usersContainer">
      <h2 style={{fontStyle: "italic" , fontWeight:"bold" , fontSize:"large"}}>Users Information</h2><br></br>
      <p style={{fontStyle: "italic" ,fontSize:"large"}}>
      ...
      <button onClick={getUsers} className="btn btn-outline-success" style={{fontStyle: "italic" , fontWeight:"bold" , fontSize:"large"}}>
        Get Users Data
      </button>
